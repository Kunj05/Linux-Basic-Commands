...
3. [Bug Bounty Programs](#bug-bounty-programs)
    - [Introduction to Bug Bounty Programs](#introduction-to-bug-bounty-programs)
    - [Articles for Starting in Bug Bounty Hunting](#articles-for-starting-in-bug-bounty-hunting)
    - [Recommended Books](#recommended-books)

4. [Resources](#resources)
    - [Documentation and References](#documentation-and-references)
    - [Bug Bounty Programs](#bug-bounty-programs-list)
